...
app_description = "Enterprise Loan Management SaaS System"
...
web_include_js = [
	...
	_versioned_asset("js/lms_collect_pwa.js", "/assets/lms_saas/js/lms_collect_pwa.js"),
]
...
doc_events = {
    "User": {
        "before_validate": "lms_saas.api.staff.apply_lms_module_profile",
    },
